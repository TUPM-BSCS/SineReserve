...
(8,'Inside Out','After young Riley is uprooted from her Midwest life and moved to San Francisco, her emotions - Joy, Fear, Anger, Disgust and Sadness - conflict on how best to navigate a new city, house, and school.','PG','210.0000','2015-06-19'),
(9,'Pixels','When aliens misinterpret video feeds of classic arcade games as a declaration of war, they attack the Earth in the form of the video games.','PG-13','205.0000','2015-06-24'),
(10,'The Little Ghost','The Little Ghost lives in the castle over looking a small town and awakens for precisely one hour after the clock strikes midnight. Follow him on this adventure to see his first sunrise ever!','PG','200.0000','2015-09-02'),
(11,'No Escape','In their new overseas home, an American family soon finds themselves caught in the middle of a coup, and they frantically look for a safe escape in an environment where foreigners are being immediately executed.','R','205.0000','2015-08-26'),
(12,'Hitman: Agent 47','An assassin teams up with a woman to help her find her father and uncover the mysteries of her ancestry.','R','205.0000','2015-08-21'),
(13,'Star Wars: Episode V','A continuation of the saga created by George Lucas set thirty years after Star Wars: Episode VI - Return of the Jedi (1983).','','0.0000','2015-12-18'),
(14,'Maze Runner: The Sco','After having escaped the Maze, the Gladers now face a new set of challenges on the open roads of a desolate landscape filled with unimaginable obstacles.','PG-13','0.0000','2015-09-18'),
(15,'Heneral Luna','A Filipino general who believes he can turn the tide of battle in the Philippine-American war. But little does he know that he faces a greatest threat to the country\'s revolution against the invading Americans.',NULL,'0.0000','2015-09-09'),
(16,'Felix Manalo','Felix Manalo covers Manalo\'s life, particularly his religious journey that culminated in his establishing the Iglesia ni Cristo, which he registered with the Philippine government on 27 July 1914. The film will also depict the origins of the church during the American Occupation, its growth in the Philippines and the church\'s struggles before it reached its present stature.[','','0.0000','2015-10-07'),
(18,'Suicide Squad','A secret government agency recruits imprisoned supervillains to execute dangerous black ops missions in exchange for clemency.',NULL,'0.0000','2016-08-05'),
(19,'Captain America: Civ','An incident leads to the Avengers developing a schism over how to deal with situations, which escalates into an open fight between allies Iron Man and Captain America.',NULL,'0.0000','2016-05-06'),
(20,'Alice Through The Lo','Plot is still unknown.',NULL,'0.0000','2016-05-27'),
(21,'Finding Dory','The friendly-but-forgetful blue tang fish reunites with her loved ones, and everyone learns a few things about the true meaning of family along the way.',NULL,'0.0000','2016-06-17'),
(22,'Kung Fu Panda 3','Continuing his \"legendary adventures of awesomeness\", Po must face two hugely epic, but different threats: one supernatural and the other a little closer to his home.',NULL,'0.0000','2016-01-29');

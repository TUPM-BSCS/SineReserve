...
<!--          <a href="#" data-activates="mobile-nav" class="right button-collapse"><i class="mdi-navigation-more-vert"></i></a>-->
          <ul class="right hide-on-large-only">
              <li><a href="<?php echo base_url();?>index.php/Home/home#movies"><i class="mdi-av-movie"></i></a></li>
          ...
          <ul class="right hide-on-med-and-down">
                ...
                <li><a href="http://localhost/SineReserve/index.php/Home/home#movies"><i class="mdi-av-movie left"></i>Movies</a></li>

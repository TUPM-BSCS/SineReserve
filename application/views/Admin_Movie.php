				...
				<div class="modal-content">
					<div class='row'>
						...
						<div class="file-field input-field col s12 m6">
						  <div class="btn">
							<span>Import</span>
							<input id='add_imdb_screenshot_btn' type="file" accept="image/png, image/jpeg" disabled>
						  </div>
						  <div class="file-path-wrapper">
							<input id='add_imdb_screenshot' class="file-path validate truncate" type="text" placeholder="Upload Screenshots Here" disabled>
						  </div>
						</div>
						
						<div class="input-field col s12 m4">
							<select id='add_imdb_rate' disabled>
						...
						<div class="input-field col s12 m12">
							<div id='add_imdb_screenshot_list' class='row'>
							</div>
						</div>
						<div class="input-field col s12 m6">
							<div class='row'>
